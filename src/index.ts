...
app.get("/depth", (req: any, res: any) => {
  const depth: {
    [price: string]: {
      type: "bid" | "ask",
      quantity: number,       //cumulative quantity
    }
  } = {};
...
app.get("/quote", (req, res) => {
  // We will simply send the lowest bid price asked if quantity is more than the ask else we will send the average price
});
